    ...
    Microsoft.Extensions.Options.IOptions<RiftboundOptions> opts) =>
{
    ...
    client.DefaultRequestHeaders.UserAgent.ParseAdd(
        "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/126.0.0.0 Safari/537.36");
    client.DefaultRequestHeaders.Add("Origin", "https://locator.riftbound.uvsgames.com");
    client.DefaultRequestHeaders.Referrer = new Uri("https://locator.riftbound.uvsgames.com/");
